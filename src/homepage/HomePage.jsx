  ...
  const renderContent = () => {
    switch (currentPage) {
      ...
      default:
        return (
          <>
            <section className="services-section" style={{"--animation-order": 1}}>
              <ServicesGrid />
            </section>
