    ...
    <div className="home-page">
      <header className="hero-section">
        ...
        <div className="nav-container">
            <button className="nav-btn"><svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
Guides</button>
            <button className="nav-btn"> <svg width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
...
Notre processus</button>
            <button className="nav-btn"><svg width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
Technologies</button >
      ...
      <section className="services-section">
       ...
       <img className="imagesponsor" src="src/assets/images/sponsor.png" alt="Test Image" />
